...
#BOOTLOADER_ADDRESS = 3E000	#for mega 2560
...
CDEFS = -DBOOT_ADR=$(BOOTLOADER_ADDRESS) -DF_CPU=$(F_CPU)UL

ADEFS = -DBOOT_ADR=$(BOOTLOADER_ADDRESS) -DF_CPU=$(F_CPU)
...
ASFLAGS = -Wa,-adhlns=$(<:.S=.lst),-gstabs  $(ADEFS)
